            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-5 sm:px-6 sm:py-4 lg:px-8 md:justify-start md:space-x-10">
              <div>
                <a href="#" className="flex">
                  <span className="sr-only">Arunraj</span>
                  <img
                    className="w-12 sm:h-10"
                    src="https://firebasestorage.googleapis.com/v0/b/portfolio-40aa5.appspot.com/o/typeface.svg?alt=media&token=935fd5e8-6135-45e5-a050-6e74743a439f"
                    alt=""
                  />
                </a>
              </div>
